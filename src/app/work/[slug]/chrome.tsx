        ...
        <div className="grid-cols-main grid">
          <div className="pr-24">
            ...
            <p className="mt-4">
              ...
              risus, porta ac consectetur ac, vestibulum at eros. Cum sociis
              ...
              porttitor ligula, eget lacinia odio sem nec elit. Nullam id dolor
              id nibh ultricies vehicula ut id elit. Maecenas sed diam eget
              risus varius blandit sit amet non magna.
            </p>
            <div className="mt-8">
              <p className="text-sm text-primary-foreground">Tech Stack Used</p>
